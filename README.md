...
https://github.com/Chisel-blocks/chisel-blocks-utils , 20250313
...
## Testing
Tests are located under `src/test/scala/clockmux_glitchfree`. You can run them with `make test_clockmux_glitchfree`.
